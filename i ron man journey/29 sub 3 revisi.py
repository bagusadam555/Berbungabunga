...
Dekat = IT2FS(domainJarak,
 ...
 trapezoid_mf, [1, 250, 750, 830, 0.55])
Jauh = IT2FS(domainJarak,
 trapezoid_mf, [800, 1100, 1850,2000, 1.],
 trapezoid_mf, [850, 1100, 1800, 1950, 0.35])
...
Kecil = IT2FS(domainBedaKecepatan,
 ...
 trapezoid_mf, [0.1, 0.33, 3.23, 3.45, 0.35])
Besar = IT2FS(domainBedaKecepatan,
 trapezoid_mf, [2.5, 3.6, 18, 20, 1.],
 trapezoid_mf, [2.6, 3.7, 17.8, 19, 0.65])
...
LowRisk =IT2FS(domainKecepatanAngin,
 ...
 trapezoid_mf, [0.5, 0.8, 13.3,  15.3, 0.7])
HighRisk = IT2FS(domainKecepatanAngin,
 trapezoid_mf, [13.61,   15.8,   26,    27,  1],
 trapezoid_mf, [14,      15.7, 26.5,  26.8, 0.65])
...
TJ = IT2FS(domainJarakPandang,
 trapezoid_mf, [0.2, 0.8, 2.5, 3, 1.],
 trapezoid_mf, [0.3, 0.9, 2.3, 2.9, 0.65]) 
J = IT2FS(domainJarakPandang,
 trapezoid_mf, [2.5, 3, 8.9, 10, 1.],
 trapezoid_mf, [2.6 , 3.1, 8.6, 9.5, 0.45])
...
myIT2FLS.add_rule([("Jarak", Dekat), ("BedaHeading", OT), ("BedaKecepatan", Kecil), ("KecepatanAngin", LowRisk), ("CurahHujan", CR), 
                   ("JarakPandang",TJ)], [("HasilKeputusan", YesTrans)])
# 2
myIT2FLS.add_rule([("Jarak", Dekat), ("BedaHeading", OT), ("BedaKecepatan", Kecil), ("KecepatanAngin", LowRisk), ("CurahHujan", CR), 
                   ("JarakPandang",J)], [("HasilKeputusan", YesTrans)])
# 3
...
myIT2FLS.add_rule([("Jarak", Dekat), ("BedaHeading", OT), ("BedaKecepatan", Kecil), ("KecepatanAngin", LowRisk), ("CurahHujan", HL), 
                   ("JarakPandang",TJ)], [("HasilKeputusan", NoTrans)])
# 6
myIT2FLS.add_rule([("Jarak", Dekat), ("BedaHeading", OT), ("BedaKecepatan", Kecil), ("KecepatanAngin", LowRisk), ("CurahHujan", HL), 
                   ("JarakPandang",J)], [("HasilKeputusan", NoTrans)])
# 7
