...
# 1
myIT2FLS.add_rule([("delD", Near),("delHead", OT), ("delV", kecil)], [("Result", YesTrans)])
# 2
myIT2FLS.add_rule([("delD", Near),("delHead", OT), ("delV", besar)], [("Result", NoTrans)])
# 3
myIT2FLS.add_rule([("delD", Near),("delHead", C), ("delV", kecil)], [("Result", YesTrans)])
# 4
myIT2FLS.add_rule([("delD", Near),("delHead", C), ("delV", besar)], [("Result", NoTrans)])
# 5
myIT2FLS.add_rule([("delD", Near),("delHead", HO), ("delV", kecil)], [("Result", YesTrans)])
# 6
myIT2FLS.add_rule([("delD", Near),("delHead", HO), ("delV", besar)], [("Result", NoTrans)])
# 7
myIT2FLS.add_rule([("delD", Far),("delHead", OT), ("delV", kecil)], [("Result", YesTrans)])
# 8
myIT2FLS.add_rule([("delD", Far),("delHead", OT), ("delV", besar)], [("Result", NoTrans)])
# 9
myIT2FLS.add_rule([("delD", Far),("delHead", C), ("delV", kecil)], [("Result", YesTrans)])
# 10
